      ...
      const htmlContent = `
        <div style="margin: 100px;font-family: monospace, monospace;">
            ...
            <div style="margin: 50px 0;">
                <p>
                    Yo, <u>${formData.nombreCompleto}</u> con DNI <u>${formData.dni}</u> Con
                    dirección de vivienda en <u>${formData.address}</u>.
                </p>
            </div>
            <div>
                <p>
                    Hoy día ${today.getDate()}/${today.getMonth() + 1}/${today.getFullYear()}
                ...
                <ol>
                    ...
                    <p>
                    ${formData.comisiones .map( (com) => `
                    ${com.fecha} importe de: ${com.importe} €<br />
                    ` ) .join("")}
                    <p>
                        <b>
                            Resultando un importe total de: ${formData.comisiones .reduce((acc,
                            curr) => acc + parseFloat(curr.importe || 0), 0) .toFixed(2)}
                            €
                        </b>
                    </p>
                    </li>
...
const styles = StyleSheet.create({
  ...
  loader: { flex: 1, justifyContent: "center", alignItems: "center",backgroundColor: "#f2e8cf" },
